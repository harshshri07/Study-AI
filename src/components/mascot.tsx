 ...
 */
export function Mascot({ className = "", animated = false }: { className?: string; animated?: boolean }) {
  return (
    <svg
      viewBox="0 0 200 200"
      className={className}
    ...
    >
      ...
      <g className={animated ? "origin-center" : ""}>
        <circle cx="82" cy="94" r="7" fill="oklch(0.11 0.01 260)">
          {animated && <animate attributeName="r" values="7;1;7" dur="4s" repeatCount="indefinite" keyTimes="0;0.05;0.1" />}
        </circle>
